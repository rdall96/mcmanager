...
enum TestData {
    ...
    static func createServer() -> MinecraftServer {
        MinecraftServer(
            name: "Test server",
            type: .java,
